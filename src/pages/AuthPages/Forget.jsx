...
function Forget() {
    ...
    function handleNewPass() {
        ...
        newExecute("user/change-pass", {"email" : email, "password": newPassword, "password_confirmation": passwordConfirmation, "code" : code});
    }

  return (
      <section style={{height:"100vh"}} className={Style.section}>
          {!sentCode && (
